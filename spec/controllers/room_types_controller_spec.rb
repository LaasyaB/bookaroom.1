  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns a newly created room_type as @room_type" do
        ...
        expect(assigns(:room_type)).to be_persisted
      end
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved room_type as @room_type" do
        post :create, {:room_type => invalid_attributes}, valid_session
        expect(assigns(:room_type)).to be_a_new(RoomType)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested room_type" do
        room_type = RoomType.create! valid_attributes
        put :update, {:id => room_type.to_param, :room_type => new_attributes}, valid_session
        room_type.reload
    ...
    context "with invalid params" do
      it "assigns the room_type as @room_type" do
        room_type = RoomType.create! valid_attributes
        put :update, {:id => room_type.to_param, :room_type => invalid_attributes}, valid_session
        expect(assigns(:room_type)).to eq(room_type)
      end
